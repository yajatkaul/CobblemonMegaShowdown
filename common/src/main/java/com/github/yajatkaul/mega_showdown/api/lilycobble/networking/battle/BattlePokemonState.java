...
public record BattlePokemonState(
    ...
    public static BattlePokemonState of(BattlePokemon pokemon, boolean includeProperties, boolean includeAbility, boolean includeMoves, boolean includeItem) {
        ...
        if (extractors.isEmpty()) properties = Optional.empty();
            ...
            properties = Optional.of(new PokemonPropertiesSupplier(pokemon.getEffectedPokemon().createPokemonProperties(extractors)));
    ...
    private record BattlePokemonStateP1(UUID uuid, Optional<PokemonPropertiesSupplier> properties,
                                        double healthPercentage) {
    ...
    private record BattlePokemonStateP2(Optional<String> status, Optional<String> item,
                                        Map<String, Integer> statChanges, Optional<List<String>> moves) {
